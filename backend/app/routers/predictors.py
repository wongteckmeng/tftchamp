...
async def models(
    ...
    output: MDIOutput = model.get_feature_importance()
    return output
...
async def find_image(id: str, request: Request, platform: Platform = 'na1', league: League = 'challengers', version: str = "12.15.458.1416", patch: str = "2022-08-10"):
